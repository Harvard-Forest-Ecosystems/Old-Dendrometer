	...
	tow.anpp <- matrix(NA, nrow = 11, ncol = 5, dimnames = list(c("2000", "2001", "2002", "2003", "2004", "2005", "2006", "2007","2008", "2009","2010"), 	c("AGWI", "AGWI.ingrowth", "fine.litterfall", "ANPP.MgC/ha", "ANPP.gC/m^2")))
	#---------------------------------------------------------------------------	
	# places AGWI in summary object 
	tow.anpp[c(1:11),1] <- tow.ann.sum[c(8:18), 1]
	#---------------------------------------------------------------------------
	...
	source("//eft.as.harvard.edu/DATA/HF_DATA/HF_BIOMETRY_WOFSY/trees/s.scripts/calc.kgC.txt")
	...
	tow.anpp[c(1:11),3] <- lit.sum[c(3:13),6]
	#---------------------------------------------------------------------------
